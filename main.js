...
(function(){
  ...
  var html = badges.map(function(b){
    return '<button class="filter-btn'+(b==='all'?' active':'')+'" onclick="filter(\''+b+'\',this)">'+(labels[b]||b)+'</button>';
  }).join('');
...
const WORKS_OLD = [
  {
    ...
    github: 'https://github.com/*****/work-report'
  },
  {
    badge: 'VBA',
    ...
    github: 'https://github.com/*****/work-invoice'
  },
  {
    badge: 'GAS',
    ...
    github: 'https://github.com/*****/work-gas'
  },
  /* ---- 作品4以降をここに追加 ---- */
];
...
/* 旧コード削除済み — config.js・新main.jsに移行完了 */
